...
export class ShipmentComponent implements OnInit {
  ...
  productExchanged = new FormControl('', Validators.required);
  ...
  constructor(public serviceShipment: ShipmentService, fb: FormBuilder) {
    this.myForm = fb.group({
      ...
      productExchanged: this.productExchanged
    });
  };
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      ...
      'productExchanged': this.productExchanged.value
    };
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.productExchanged) {
        formObject.productExchanged = result.productExchanged;
      } else {
        formObject.productExchanged = null;
      }
